...
std::string twoandthree(int scramble_length, int gen) {
	const std::string moves[18] = { "F ", "F' ", "F2 ", "R ", "R' ", "R2 ", "U ", "U' ", "U2 ", "B ", "B' ", "B2 ", "L ", "L' ", "L2 ", "D ", "D' ", "D2 "};
	std::string scramble = "";
	int y = rannum_f(3);
	int x = rannum_f(gen);
	int xarray[25] = { 0 };
	...
	while (i < scramble_length) {
		...
		if (xarray[i - 1] != x) {
			if (xarray[i - 2] == x) {
				if ((x + xarray[i - 2]) != 1 && (x + xarray[i - 2]) != 5 && (x + xarray[i - 2]) != 9) {
					xarray[i] = x;
					scramble = scramble + moves[3 * x + y];
					i++;
				}
...
std::string fourandfive(int scramble_length) {
	const std::string moves[36] = { "F ", "F' ", "F2 ", "Fw ", "Fw' ", "Fw2 ", "R ", "R' ", "R2 ", "Rw ", "Rw' ", "Rw2 ", "U ", "U' ", "U2 ", "Uw ", "Uw' ", "Uw2 ", "B ", "B' ", "B2 ", "Bw ", "Bw' ", "Bw2 ", "L ", "L' ", "L2 ", "Lw ", "Lw' ", "Lw2 ", "D ", "D' ", "D2 ", "Dw ", "Dw' ", "Dw2 "};
	std::string scramble = "";
	int x = rannum_f(6);
	int y = rannum_f(3);
	int xarray[60] = { 0 };
